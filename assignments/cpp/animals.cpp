...
public:
  ...
  virtual void move() {
    cout << "  ANIMAL " << name << " : I'm moving" << endl;
  }
...
public:
  ...
  void move() override {
    cout << "  DOG " << name << " : I'm running!" << endl;
  }
...
public:
  ...
  virtual void move() override {
    cout << "  CAT " << name << " : Later." << endl;
  }
};

class Alligator : public Animal {
public:
  Alligator(string s = "Toothy") : Animal(s) {}
  void speak() override { cout << "  ALLIGATOR " << name << " : Chomp!" << endl; }
  void move() override {
    cout << "  ALLIGATOR " << name << " : I'm swimming!" << endl;
  }
};
...
void new_main(void) {
  Animal *anPtr[3] = {new Dog(), new Alligator(),new Cat()};

  for (Animal *ptr : anPtr) {
    ptr->eat();
    ptr->move();
    ptr->speak();
  }
